\part{Synthesis}
	...
	\chapter{Testing}
		...
		Problems such as the motors freezing up or the microcontroller displaying its error lights will indicate flaws in the program's implementation, and further investigation will be needed to determine what is going wrong at run time.
		...
		During the project's development a 'bottom up' style of testing was involved. This involved fundamental bottom level units being tested for basic functionality, and then further tests taking place as these units were joined together.
