\part{Analysis}
		...
		There are a few objectives in the Terms of Reference relating to the robot's capabilities. First and foremost the robot must be capable of basic navigation. Second, the drone must be capable of observing the environment and processing this data somehow. Finally, the robot must be capable of performing localization and mapping. From these we can get these basic requirements -
		
		\begin{itemize}
			\item The robot must be capable of movement
			\item The robot must be capable of observation
			\item The robot must be capable of storing/processing observational data
		\end{itemize}
	
		Everything from the justification of equipment, to the gathering of relevant literature, to the actual software programming of the robot should have the ultimate goal of achieving these objectives.
