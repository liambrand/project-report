\part{Analysis}
		...
		\chapter{Developing The Robot}
			...
			\section{Observation}
			To achieve self navigation as well as mapping, the robot will need to take observations about its surrounding environment. This section aims to explore a few of the different methods that could be used for this, and ultimately to draw a conclusion on what method we will use.
			
				\subsection{Infrared}
				Infrared sensors work by measuring things via the reflection of infrared light. The sensor will send out some infrared light where it will be reflected off of an obstacle. A reciever will capture this reflected light and depending on factors such as how much light is recieved back and the triangulation of how the light was recieved the presence of an obstacle will be determined. 
