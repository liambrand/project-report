...
static void writeTest() {
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{APPENDICES/k64fpinout.jpg}
		\caption{K64F Pinout}
		\label{fig:k64fpinout}
	\end{figure}
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{APPENDICES/k64fperipherals.png}
		\caption{K64F Peripherals}
		\label{fig:k64fperipherals}
	\end{figure}
	\includepdf[pages=-, landscape=true]{APPENDICES/k64fcircuitdiagram.pdf}				
	\chapter{Ethics Form}
